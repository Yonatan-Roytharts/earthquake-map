...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		AbstractMapProvider provider = new Google.GoogleTerrainProvider(); // Google blocked me
		AbstractMapProvider microsoft = new Microsoft.AerialProvider();    // So I use Microsoft!
		// Set a zoom level
		int zoomLevel = 10;
		...
		map1 = new UnfoldingMap(this, 50, 50, 350, 500, microsoft);
		...
		map2 = new UnfoldingMap(this, 410, 50, 350, 500, microsoft);
		
		map2.zoomAndPanTo(zoomLevel, new Location(31.663200, 34.564620));
